 ...
 * @author mac
 */
@ManagedBean (name = "allProductsMB")
@ViewScoped
public class AllProductsMB {
    ...
    /**
     * Creates a new instance of AllProductsMB
     */
    ...
    public void onRowSelect(SelectEvent event) throws IOException {
        ...
        FacesContext.getCurrentInstance().getExternalContext().redirect("../AdminPortal/viewProductDetail.xhtml");
    }
//**************************************web services**************************************
